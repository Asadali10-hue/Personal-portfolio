    ...
    <AnimatedGridBackgroundSection >
      ...
      >
        ...
        <div className="relative flex flex-col gap-2">
          <div className="lg:mr-32 xl:text-[60px] titleVideo titleVideo1">Videos</div>
          <div className="font-bold text-main lg:ml-56 xl:text-[80px] titleVideo titleVideo2">that makes</div>
          <div className="lg:mr-40 xl:text-[60px] titleVideo titleVideo1">your brand spread</div>
          <div className="font-bold text-main xl:text-[80px] titleVideo titleVideo2">like wildfire</div>
